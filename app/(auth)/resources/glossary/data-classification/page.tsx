...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Classification | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data classification."
  };
  ...
  const relatedTerms = [
    {
      ...
      "description": "Data categorization involves organizing data into groups based on shared characteristics."
    },
    {
      "title": "Data Class",
      "description": "Data class allows programmatic identification of various data types within a storage system, typically using specific tests or algorithms."
    }
  ];
