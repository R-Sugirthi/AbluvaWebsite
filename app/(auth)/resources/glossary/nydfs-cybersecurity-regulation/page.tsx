...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "NYDFS Cybersecurity Regulation | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for NYDFS Cybersecurity Regulation."
  };
  
  const mainTerm = {
    "title": "NYDFS Cybersecurity Regulation",
    "description": "Established by the New York Department of Financial Services (NYDFS), this regulation mandates financial institutions to implement specific cybersecurity controls, covering areas like risk assessment, incident response, and vendor management."
  };
  
  const relatedTerms = [
    {
      "title": "Notice At Collection",
      "description": "CCPA Section 1798.100 Requires businesses to clearly inform consumers at the point of data collection about what types of personal information are being gathered. That is termed as Notice at collection."
    },
    {
      "title": "NIST",
      "description": "The National Institute of Standards and Technology (NIST) is a U.S. government agency that sets measurement standards and develops security guidelines for federal institutions."
    }
  ];
