  ...
  return (
    <>
      ...
      <section className='founder'>
        ...
        <div className='bg-black darkText px-4 lg:px-28 py-20' id="IntrusionDetection">
          <div>
            <h1 className="text-5xl  text-gradient lineht text-center">Intrusion Detection</h1>
        ...
        <div className='bg-black px-4 md:px-28 pb-20 text-2xl darkText text-gray-300'>
          ...
          <h1 className="text-4xl  text-gradient text-center pt-20">Graphene - Where complexity meets clarity and transparency.
</h1> 
