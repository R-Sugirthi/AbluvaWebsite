...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "CDO - Chief Data Officer | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "CDO - Chief Data Officer",
    "description": "Within an organization, the CDO serves as the executive champion for data governance and strategy. They oversee critical aspects like information security, data quality, and analytics, driving initiatives to maximize the value of data while ensuring responsible data management practices and compliance with relevant regulations."
  };
  
  const relatedTerms = [
    {
      "title": "CISO",
      "description": "Chief Information Security Officer (CISO) is an executive responsible for managing an organization's information security strategy and operations. The CISO ensures compliance with privacy regulations and internal security policies, protecting sensitive information and mitigating cyber threats."
    },
    {
      "title": "CPO",
      "description": "Chief Privacy Officer (CPO) is an executive responsible for overseeing an organization's privacy governance and compliance efforts. The CPO ensures responsible data collection, usage, and protection, building trust with customers and stakeholders."
    }
  ];
