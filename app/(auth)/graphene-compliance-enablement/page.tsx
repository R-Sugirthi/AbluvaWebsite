    ...
    <>
      ...
      <section className='founder'>
        ...
        <div className='bg-[#f2f3f5]'>
          ...
          <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 px-28 py-20'>
        ...
        <div className='bg-[#f2f3f5] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 px-28 py-10'>
          ...
          <div className='px-28 bg-[#f2f3f5] py-5' >
        ...
        <div className='bg-[#f2f3f5] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 px-28 pt-20'>
          <div className="flex flex-col justify-center">
        ...
        <div className='bg-[#f2f3f5] px-28 py-20'>
