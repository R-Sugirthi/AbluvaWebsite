...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Cross-Border Data Transfer | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "Cross-Border Data Transfer",
    "description": "Cross-border data transfers refer to the movement of personal data across international borders."
  };
