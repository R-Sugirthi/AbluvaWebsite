...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Retention | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data retention."
  };
  ...
  const relatedTerms = [
    ...
    },
    {
      ...
      "description": "Data minimization is the principle of collecting and retaining only the essential personal data required for specific purposes."
    }
  ];
