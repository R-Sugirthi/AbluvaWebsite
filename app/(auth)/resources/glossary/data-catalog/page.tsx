...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Catalog | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data catalog."
  };
  
  const mainTerm = {
    "title": "Data Catalog",
    "description": "A data catalog acts as a comprehensive inventory of an organization's data assets, utilizing metadata to facilitate data management."
  };
  
  const relatedTerms = [
    {
      "title": "Data Inventory",
      "description": "An authoritative record identifying and mapping the location and sharing practices of personal data within systems."
    },
    {
