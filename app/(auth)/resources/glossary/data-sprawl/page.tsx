...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Sprawl | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data sprawl."
  };
  ...
  const relatedTerms = [
    {
      ...
      "description": "DSPM emerges as a cutting-edge technology recognized by Gartner to address the challenge of data sprawl in cloud environments. It empowers security and compliance teams to answer three critical questions: where is our data, what data is sensitive, and are we secure."
    },
    {
      "title": "Data Minimization",
      "description": "The principle emphasizing collecting and retaining only the essential personal data required for specific purposes. This promotes responsible data handling, reduces storage costs, and minimizes security risks associated with excessive data collection."
    }
  ];
