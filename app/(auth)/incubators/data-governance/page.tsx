...
export const metadata = {
  ...
  description: 'Graphene: Elevating data governance—secure, compliant, and efficient.',
};
    ...
    <>
      ...
      <div className='bg-black md:px-28 py-28 px-5 text-2xl text-gray-300 darkText ' id="DataGovernance">
        ...
        <div className="link-wrapper  text-center">
            <Link className="hover-2 text-gradient text-3xl font-semibold pt-5" href="/company/contact">Contact us to know more about Graphene's data governance capabilities  &#x2192;</Link>
          </div>
        </div>
      </section>
