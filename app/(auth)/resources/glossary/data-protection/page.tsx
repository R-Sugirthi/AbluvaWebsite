...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Protection | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data protection."
  };
  
  const mainTerm = {
    "title": "Data Protection",
    "description": "Data protection encompasses a legal framework of laws and regulations designed to safeguard individuals' personal data and dictate its ethical use."
  };
  
  const relatedTerms = [
    {
      "title": "Data Controller",
      "description": "In the context of GDPR, the data controller determines the 'how' and 'why' of data processing, setting the objectives and overseeing its execution."
    },
    {
      "title": "Data Processor",
      "description": "An organization entrusted with handling personal data on behalf of a Data Controller (collection, storage, processing, transmission)."
    }
  ];
