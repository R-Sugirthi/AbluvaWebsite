...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Protection Principle | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data protection principle."
};

const mainTerm = {
    "title": "Data Protection Principle",
    "description": "The data protection principle encompasses the core principles established by GDPR (Article 5) for data protection, emphasizing lawfulness, fairness, and transparency; purpose limitation; data minimization; accuracy; storage limitation; and integrity and confidentiality."
};

const relatedTerms = [
  {
      "title": "Data Redaction",
      "description": "Redaction protects sensitive information by obscuring it in physical or electronic documents. Commonly used in legal contexts, it allows relevant content to be shared while shielding personally identifiable data, intellectual property, or other confidential details. Redaction methods range from physical blackouts to digital tools that blur or distort data, ensuring sensitive information remains safeguarded."
  },
  {
      "title": "Data Residency",
      "description": "Data residency refers to the physical location where data is stored, often dictated by privacy regulations or internal compliance policies."
  }
];
