...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Broker | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data broker."
  };
  ...
  const relatedTerms = [
    ...
    },
    {
      ...
      "description": "The core principles established by GDPR (Article 5) for data protection, emphasizing lawfulness, fairness, and transparency."
    }
  ];
