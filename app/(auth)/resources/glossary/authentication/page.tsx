...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Authentication | Abluva Glossary",
  ...
  const relatedTerms = [
    ...
    },
    {
      ...
      "description": "Automated processing streamlines data handling by employing technology to execute tasks without manual intervention. This encompasses various scenarios, from data analysis and report generation to algorithmic decision-making."
    }
  ];
