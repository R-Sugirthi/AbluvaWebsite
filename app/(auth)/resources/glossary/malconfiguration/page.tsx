...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Malconfiguration | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for malconfiguration."
  };
  
  const mainTerm = {
    "title": "Malconfiguration",
    "description": "Malconfiguration refers to a deliberate alteration of system configurations by malicious actors, often aiming to establish persistent access or exfiltrate data. This can involve exploiting compromised accounts or vulnerabilities, offering long-term access even after closing the initial vulnerability."
  };
  
  const relatedTerms = [
    {
      "title": "Malware",
      "description": "An umbrella term encompassing various types of malicious software designed to infiltrate and harm computer systems or networks."
    },
    {
      "title": "Managed Database",
      "description": "A database where storage, data, and computing services are outsourced to a third-party provider, relieving internal IT staff from management and maintenance tasks."
    }
  ];
