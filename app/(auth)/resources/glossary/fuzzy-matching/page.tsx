...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Fuzzy Matching | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for fuzzy matching."
  };
  
  const mainTerm = {
    "title": "Fuzzy Matching",
    "description": "Unlike exact matching, this method scores data matches from 0 to 100 based on the degree of similarity between search and file data values, offering greater flexibility."
  };
  
  const relatedTerms = [
    {
      "title": "False Positive",
      "description": "A false positive occurs when an alert system erroneously identifies a non-existent vulnerability or malicious activity, generating noise and requiring unnecessary investigation by security teams."
    },
    {
