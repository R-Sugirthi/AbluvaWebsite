...
export const metadata = {
  ...
  description: 'Graphene: Simplify compliance, enhance data security.',
};
      ...
      <section className='founder'>
        ...
        <div className='bg-[#f2f3f5]'>
          ...
          <div className='image-container flex items-center'>
            <img src="https://img.freepik.com/premium-vector/isometric-security-data-protection-concept-server-pc-monitor-tablet-phone-laptop-cloud-network-illustration_114482-90.jpg?w=826" className='rounded-lg' alt="compliance-enablement" />
        ...
        <div className=' flex items-center md:order-1 order-2'>
          <div className='image-container'>
            <img src="https://img.freepik.com/premium-vector/landing-page-data-security-vector-based_607987-5.jpg?w=900" className='rounded-lg' alt="compliance-enablement"/>
            <div className='image-overlay rounded-lg'></div>
          </div>
          </div>
        ...
        <div className='bg-[#f2f3f5] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:px-28 px-5 md:py-10 py-5'>
          ...
          <div className='image-container flex items-center'>
            <img src="https://img.freepik.com/free-vector/biometrics-blockchain-technology-illustration-digital-fingerprint-security-cryptocurrency_33099-345.jpg?w=740&t=st=1702400381~exp=1702400981~hmac=cb74cabd0c4af7d9837e50a252466667889f1f6927f8f3447d00c3f67a3f8422" className='rounded-lg' alt="compliance-enablement"/>
            <div className='image-overlay rounded-lg'></div>
          </div>
          </div>
          ...
          <div className="link-wrapper  text-center">
            <Link className="hover-2 text-gradient-light text-3xl font-semibold" href="/company/contact">Connect with us to find out more about the compliance capabilities of Graphene  &#x2192;</Link>
          </div>
        </div>
        ...
        <div className=' flex items-center md:order-1 order-2'>
          <div className='image-container'>
            <img src="https://img.freepik.com/premium-photo/document-management-system-dms-being-setup-it-consultant-working-laptop-computer-office-software-archiving-searching-managing-corporate-files-information_35148-4647.jpg?w=900" className='rounded-lg' alt="compliance-enablement"/>
            <div className='image-overlay rounded-lg'></div>
          </div>
          </div>
          <div className="flex flex-col justify-center md:order-2 order-1">
        ...
        <div className='bg-[#f2f3f5] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:px-28 md:pt-20 pt-10 px-5'>
          ...
          <div className='image-container flex items-center'>
            <img src="https://img.freepik.com/premium-vector/isometric-analysis-data-investment-project-management-business-communication-workflow-consulting-website-mobile-website-development-seo-mobile-apps-business-solutions_589019-3568.jpg?w=740" className='rounded-lg' alt="compliance-enablement"/>
            <div className='image-overlay rounded-lg'></div>
          </div>
          </div>
