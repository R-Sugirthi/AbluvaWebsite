          ...
          <div className='py-10'>
            <div className='py-20 border-t border-gray-300'>
              ...
              <div className="link-wrapper">
                <Link className="hover-2 text-gradient-light text-3xl font-semibold" href="/contact">Contact our team for a personalized demo or start your free trial today &#x2192;</Link>
              </div>
            </div>
          </div>
        </div>
