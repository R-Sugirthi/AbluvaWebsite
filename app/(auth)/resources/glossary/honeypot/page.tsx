...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Honeypot | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for honeypot."
  };
  
  const mainTerm = {
    "title": "Honeypot",
    "description": "A honeypot is a deceptive mechanism designed to lure and divert attackers away from genuine production systems. Functioning as a trap or decoy, a honeypot resembles a legitimate system in appearance and functionality, strategically positioned where unauthorized entities are likely to encounter it while seeking out potential attack vectors."
  };
