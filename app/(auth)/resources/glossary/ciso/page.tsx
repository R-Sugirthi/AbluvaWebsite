...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "CISO | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "CISO",
    "description": "As the guardian of an organization's digital domain, the Chief Information Security Officer (CISO) spearheads cybersecurity strategy and operations."
  };
  
  const relatedTerms = [
    {
      "title": "CDO",
      "description": "Chief Data Officer (CDO) serves as the executive champion for data governance and strategy."
    },
    {
      "title": "CPO",
      "description": "Chief Privacy Officer (CPO) champions an organization's privacy governance and compliance efforts."
    }
  ];
