...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "File Clustering (Unsupervised Learning) | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for file clustering (unsupervised learning)."
  };
  
  const mainTerm = {
    "title": "File Clustering (Unsupervised Learning)",
    "description": "This unsupervised learning technique groups files based on similarities, aiming for files within a group to be more alike and less similar to those in other groups."
  };
  
  const relatedTerms = [
    {
      "title": "FINRA",
      "description": "FINRA serves as a self-regulatory organization protecting investors in the U.S. securities fontets."
    },
    {
      "title": "Firewall",
      "description": "A firewall is a security measure, which can be implemented as either a hardware or software solution, designed to filter network traffic. Operating on an implicit deny principle, a firewall blocks all incoming and outgoing traffic by default."
    }
  ];
