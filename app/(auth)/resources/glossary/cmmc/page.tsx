...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "CMMC | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "CMMC",
    "description": "The Cybersecurity Maturity Model Certification (CMMC) establishes a standardized framework for assessing cybersecurity maturity."
  };
