...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Purpose Limitation (CCPA) | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for purpose limitation (CCPA)."
  };
  
  const mainTerm = {
    "title": "Purpose Limitation (CCPA)",
    "description": "As mandated by CCPA Section 1798.100, businesses must restrict personal information (PI) usage to the intended collection purposes. This requires clarity in data gathering and transparency about how information will be utilized."
  };
