...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Information Security Policy | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Information Security Policy."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "Integrity",
      "description": "The assurance that information remains unaltered, accurate, and complete. GDPR mandates data controllers and processors implement measures to guarantee data integrity."
    }
  ];
