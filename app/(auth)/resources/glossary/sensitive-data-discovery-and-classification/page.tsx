...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Sensitive Data Discovery And Classification | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Sensitive Data Discovery And Classification."
  };
  
  const mainTerm = {
    "title": "Sensitive Data Discovery And Classification",
    "description": "A process identifying and categorizing sensitive information within an organization's digital assets. This includes PII, financial data, healthcare records, and other information requiring protection."
  };
