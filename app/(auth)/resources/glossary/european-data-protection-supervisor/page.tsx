...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "European Data Protection Supervisor | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for the European Data Protection Supervisor."
  };
  
  const mainTerm = {
    "title": "European Data Protection Supervisor",
    "description": "The European Data Protection Supervisor (EDPS) is an independent authority dedicated to ensuring compliance with GDPR privacy rules by European organizations and member states."
  };
  
  const relatedTerms = [
    {
      "title": "EU-US Privacy Shield",
      "description": "The EU-US Privacy Shield, established in 2016, permitted American companies certified under the U.S. Federal Trade Commission to transfer EU citizens' personal data to the U.S."
    },
    {
      "title": "European Data Protection Board",
      "description": "The European Data Protection Board (EDPB), comprised of EU member states' data protection authorities and the European Data Protection Supervisor, serves as the primary enforcer of the General Data Protection Regulation (GDPR), ensuring its consistent application across the EU."
    }
  ];
