...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Negligence | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for negligence in data security and privacy."
  };
  
  const mainTerm = {
    "title": "Negligence",
    "description": "Negligence in Data Security/Privacy is the failure to fulfill the legal obligation to protect personal information, potentially leading to legal repercussions."
  };
