...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Protection Officer (DPO) | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Data Protection Officer (DPO)."
  };
  
  const mainTerm = {
    "title": "Data Protection Officer (DPO)",
    "description": "The DPO plays a vital role within organizations processing personal data, acting as an internal advisor and liaison with the relevant Data Protection Authority (DPA)."
  };
