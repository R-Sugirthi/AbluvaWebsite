...
export const metadata = {
  ...
  description: 'Graphene Access Control: Democratize data securely with fine-grain access, intuitive policy editing, and simplified database management.',
};
...
export default function GrapheneAccessControl() {
      ...
      <section className='founder'>
        <div className="bg-black text-black text-center py-20">
          <div className="px-4 sm:px-8 lg:px-16 xl:px-20">
            ...
            <div className='pb-40'>
              <Link href="/company/contact" className="btn-md text-xl font-semibold text-white bg-violet-950 py-4 p-3 rounded-md">
                Request to Demo
              </Link>
            </div>
  ...
  <div className="max-w-xl p-10 md:border-b border-gray-300 flex flex-col justify-center items-center">
    <ul>
      <li className='py-3'><img src="/icons/policy.png" className='h-8 mx-auto' alt="icon"/></li>
  ...
  <div className="max-w-xl p-10 md:border-l md:border-r md:border-b border-gray-300 flex flex-col justify-center items-center">
    <ul>
      <li className='py-3'><img src="/icons/RealTime.png" className='h-8 mx-auto' alt="icon"/></li>
  ...
  <div className="max-w-xl p-10 md:border-b border-gray-300 flex flex-col justify-center items-center">
    <ul>
      <li className='py-3'><img src="/icons/reduceDependency.png" className='h-8 mx-auto' alt="icon"/></li>
  ...
  <div className="max-w-xl p-10 flex flex-col justify-center items-center">
    <ul>
      <li className='py-3'><img src="/icons/multipleSystem.png" className='h-8 mx-auto' alt="icon"/></li>
  ...
  <div className="max-w-xl p-10  md:border-r md:border-l border-gray-300 flex flex-col justify-center items-center">
    <ul>
      <li className='py-3'><img src="/icons/security.png" className='h-8 mx-auto' alt="icon"/></li>
  ...
  <div className="max-w-xl p-10 flex flex-col justify-center items-center">
    <ul>
      <li className='py-3'><img src="/icons/valueFromData.png" className='h-8 mx-auto' alt="icon"/></li>
...
<div className='pt-10'>
          <div className="link-wrapper bg-[#f2f3f5] text-gradient-light text-center">
            <Link className="hover-2 text-gradient-light text-3xl font-semibold" href="/company/contact">Talk to us to know more about Graphene’s Data Depersonalization capabilities &#x2192;</Link>
...
and risk bask restriction.
          ...
          <div className='image-container flex items-center'>
            <img src="https://img.freepik.com/premium-photo/businessman-holding-shield-protect-icon-protection-network-security-computer-safe-your-data-concept-lock-symbol-concept-about-security-cybersecurity-protection-against-dangers_184421-914.jpg?w=900" className='rounded-lg' alt="data-access-control" />
  ...
  <div className='flex items-center order-2 md:order-1'>
    <div className='image-container'>
      <img src="https://img.freepik.com/premium-photo/cloud-computing-technology-online-data-storage-global-data-sharing_31965-22550.jpg?w=900" className='rounded-lg' alt="data-access-control" />
      <div className='image-overlay rounded-lg'></div>
    </div>
  </div>
    ...
    <p className='mb-4 text-2xl text-gray-700'>
      Create, inherit, and deploy policies effortlessly without any technical coding requirement. Graphene converts your click-based instructions into code and implements the access controls seamlessly across all the integrated systems.
        ...
        <div className='bg-[#f2f3f5] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:px-28 px-5 md:py-20 pt-10 pb-20'>
          ...
          <div className='image-container flex items-center'>
            <img src="https://img.freepik.com/premium-photo/businessman-holding-shield-protect-icon-protection-network-security-computer-safe-your-data-concept-lock-symbol-concept-about-security-cybersecurity-protection-against-dangers_184421-1281.jpg?w=900" className='rounded-lg' alt="data-access-control" />
            <div className='image-overlay rounded-lg'></div>
          </div>
        </div>
