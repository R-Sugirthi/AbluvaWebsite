...
export const metadata = {
  ...
  description: 'Graphene\'s Intrusion Detection: AI-driven security with GNN for early threat detection. Unmatched transparency.',
};
...
<div className="link-wrapper  text-center">
            <Link className="hover-2 text-gradient text-3xl font-semibold pt-5" href="/company/contact">Contact us to know more about Intrusion Detection  &#x2192;</Link>
          </div>
        </div>
