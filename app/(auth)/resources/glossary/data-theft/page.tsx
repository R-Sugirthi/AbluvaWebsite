...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Subject | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data subjects."
  };
  
  const mainTerm = {
    "title": "Data Subject",
    "description": "A data subject is the individual whose personal data is being collected, processed, or stored. They have specific rights under data protection laws to access, rectify, erase, or restrict the processing of their personal data."
  };
  
  const relatedTerms = [
    {
      "title": "Data Controller",
      "description": "In the context of GDPR, the data controller determines the 'how' and 'why' of data processing, setting the objectives and overseeing its execution. They can either process the data themselves or appoint a trusted third-party data processor."
    },
    {
      "title": "Data Processor",
      "description": "An organization entrusted with handling personal data on behalf of a Data Controller (collection, storage, processing, transmission). Data Processors must adhere to strict data protection obligations and safeguard entrusted information."
    }
  ];
