...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Notice At Collection | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Notice At Collection."
  };
  ...
  const relatedTerms = [
    {
      "title": "NPI",
      "description": "Nonpublic personal information (NPI) refers to confidential data about individuals not publicly available, requiring specific protection measures."
    },
    {
      "title": "NIST",
