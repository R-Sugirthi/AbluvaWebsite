...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
  "title": "Right To Deletion | Abluva Glossary",
  "description": "Expand your knowledge with our glossary term for right to deletion."
};

const mainTerm = {
  "title": "Right To Deletion",
  "description": "This grants individuals the right to request and obtain the deletion of their personal data from businesses or organizations possessing or controlling it. This reinforces individual control over their information and data privacy."
};
