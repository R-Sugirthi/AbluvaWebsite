...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Obfuscated Data | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for obfuscated data."
  };
  
  const mainTerm = {
    "title": "Obfuscated Data",
    "description": "Sensitive information masked with lookalike data, rendering it unusable for malicious actors. This is common in test environments where realistic data is needed without exposing actual information."
  };
