...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Misconfiguration | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for misconfiguration."
  };
  
  const mainTerm = {
    "title": "Misconfiguration",
    "description": "Misconfiguration refers to improper settings on an account or system that could create security vulnerabilities. While often unintentional, misconfiguration is a leading cause of data breaches and loss."
  };
