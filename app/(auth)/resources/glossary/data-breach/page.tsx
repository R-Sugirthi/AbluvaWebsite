...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Breach | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data breach."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "Data Broker",
      "description": "The GDPR defines a data broker as any entity involved in collecting and selling individuals' personal data."
    }
  ];
