...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Processing | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data processing."
  };
  
  const mainTerm = {
    "title": "Data Processing",
    "description": "Any action performed on personal data, encompassing tasks like collection, storage, analysis, and dissemination."
  };
