...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Right To Be Informed (GDPR) | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for right to be informed (GDPR)."
  };
  
  const mainTerm = {
    "title": "Right To Be Informed (GDPR)",
    "description": "As stipulated by GDPR Article 13, businesses must inform data subjects at the time of collection about the personal data gathered, its purpose, retention period, and who it will be shared with. This transparency empowers individuals to make informed choices about data sharing."
  };
  
  const relatedTerms = [
    {
      "title": "Right To Access",
      "description": "Individuals possess the right to request and receive their personal data from businesses or organizations holding it. This empowers them to understand how their information is being used and stored."
    },
    {
      "title": "Right To Be Forgotten",
      "description": "Similar to the right to deletion, this grants individuals the right to request the erasure of their personal data under specific conditions as defined by regulations like GDPR. This strengthens individual control over online presence and data minimization practices."
    }
  ];
