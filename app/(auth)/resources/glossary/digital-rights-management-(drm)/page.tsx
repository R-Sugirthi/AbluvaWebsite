...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Digital Rights Management (DRM) | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Digital Rights Management (DRM)."
  };
  
  const mainTerm = {
    "title": "Digital Rights Management (DRM)",
    "description": "Digital Rights Management (DRM) encompasses a set of access control technologies designed to safeguard confidential information, proprietary assets, and copyrighted works."
  };
