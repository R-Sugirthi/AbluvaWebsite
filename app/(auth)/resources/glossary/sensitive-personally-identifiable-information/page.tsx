...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Sensitive Personally Identifiable Information | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Sensitive Personally Identifiable Information."
  };
  
  const mainTerm = {
    "title": "Sensitive Personally Identifiable Information",
    "description": "Sensitive Personally Identifiable Information (PII) includes any data that can be used to identify an individual and is subject to heightened protection measures to prevent unauthorized access or disclosure."
  };
