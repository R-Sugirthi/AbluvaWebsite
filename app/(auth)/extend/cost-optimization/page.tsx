  ...
  return (
       ...
       <div className='bg-[#f2f3f5] md:px-28 pt-20 text-2xl text-gray-900'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 py-20">
            <div className="max-w-xl p-3 flex flex-col text-center">
                <img src="/icons/speedtime.png" className='h-10 mx-auto' alt="icon" />
                <div className='py-5'>
            ...
            <div className="max-w-xl p-3 border-l border-r border-gray-300 flex flex-col text-center">
                <img src="/icons/budget.png" className='h-10 mx-auto' alt="icon"/>
                <div className='py-5'>
            ...
            <div className="max-w-xl p-3  flex flex-col text-center">
                <img src="/icons/maintenance.png" className='h-10 mx-auto' alt="icon"/>
                <div className='py-5'>
    ...
    <div>
        ...
        <div className="link-wrapper text-center">
            <Link className="hover-2 text-gradient-light text-3xl font-semibold" href="/comapny/contact">Contact our team for insights into how Graphene's cost-effective Query Optimization can reshape your database strategy &#x2192;</Link>
          </div>    
        </div>
    </div>
        </div>
