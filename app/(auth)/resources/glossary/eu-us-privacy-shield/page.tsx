...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "EU-US Privacy Shield | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for EU-US Privacy Shield."
  };
  
  const mainTerm = {
    "title": "EU-US Privacy Shield",
    "description": "Established in 2016 as a successor to the Safe Harbor Agreement, this arrangement permitted American companies certified under the U.S. Federal Trade Commission to transfer EU citizens' personal data to the U.S."
  };
