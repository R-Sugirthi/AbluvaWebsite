...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Loss | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data loss."
  };
  
  const mainTerm = {
    "title": "Data Loss",
    "description": "Data loss refers to the unintentional or malicious disappearance of data, such as deletion, corruption, or theft."
  };
