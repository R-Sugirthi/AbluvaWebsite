    ...
    <>
      ...
      <div className='bg-[#f2f3f5]'>
        <div className="container mx-auto md-px-20">
          ...
          <img src="/images/SSDLC.png" className='md:px-20' alt="SSDLC" />
          <div className='md:px-20 px-5 pt-10'>
            ...
            <div className='pb-10 pt-5' >
              <div className="link-wrapper  text-center">
                <Link className="hover-2 text-gradient-light text-3xl font-semibold" href="/company/contact">We encourage you to learn more about our SSDLC by connecting us &#x2192;</Link>
              </div>
            </div>
          </div>
        </div>
