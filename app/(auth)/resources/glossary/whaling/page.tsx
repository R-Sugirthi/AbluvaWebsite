...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Whaling | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for whaling."
  };
  
  const mainTerm = {
    "title": "Whaling",
    "description": "Whaling, a targeted phishing attack, specifically hooks high-value individuals or key decision-makers. Hackers meticulously gather personal and professional details about these targets, crafting personalized messages that appear legitimate. This increases the lure for the victim to unwittingly disclose sensitive information or grant unauthorized access, potentially causing significant financial or reputational damage."
  };
  const relatedTerms = [
    {
      "title": "Cyberattack",
      "description": "A cyberattack refers to any endeavor to breach the security defenses of a digital environment."
    },
    {
      "title": "CVE",
      "description": "Common Vulnerabilities and Exposures (CVE) is a comprehensive database of known attacks, exploits, and compromises."
    }
  ];
