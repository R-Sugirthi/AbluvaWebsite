...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Controller | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data controller."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "Data Owner",
      "description": "Data ownership assigns clear responsibility for a dataset's classification, security, usage, and quality."
    }
  ];
