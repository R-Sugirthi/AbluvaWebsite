...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Localization | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data localization."
  };
  
  const mainTerm = {
    "title": "Data Localization",
    "description": "Data localization refers to the requirement that data be physically stored within the same geographical region where it originates."
  };
  ...
  const relatedTerms = [
    ...
    },
    {
      ...
      "description": "Data classification categorizes data based on relevant characteristics, simplifying retrieval, sorting, usage, storage, and security measures."
    }
  ];
