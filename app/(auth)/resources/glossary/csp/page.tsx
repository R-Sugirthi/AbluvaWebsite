...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "CSP | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "CSP",
    "description": "Operating across various service models (IaaS, PaaS, SaaS), CSPs deliver on-demand access to computing resources and capabilities over the internet."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "CPO",
      "description": "In today's data-driven world, the CPO champions an organization's privacy governance and compliance efforts."
    }
  ];
