...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Warehouse | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data warehouse."
  };
  
  const mainTerm = {
    "title": "Data Warehouse",
    "description": "Data warehouses act as centralized hubs designed for powerful analytics. They consolidate information from various sources, enabling holistic business intelligence activities like trend analysis, informed decision-making, and strategic planning."
  };
  
  const relatedTerms = [
    {
      "title": "Data Store",
      "description": "A centralized repository for managing and distributing large datasets within an enterprise. It provides secure, organized storage and facilitates efficient access and retrieval of data for various applications and analytics needs."
    },
    {
      "title": "Data Flow",
      "description": "The designated path information travels from its origin (source) to its final destination, traversing various intermediary points (nodes) within a system or network. Understanding data flow is crucial for ensuring data integrity, security, and efficient processing."
    }
  ];
