...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "DDoS Attack | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for DDoS attack."
  };
  
  const mainTerm = {
    "title": "DDoS Attack",
    "description": "A distributed denial-of-service (DDoS) attack is a malicious assault aimed at disrupting the normal operation of a targeted server, service, or network by inundating it with an overwhelming volume of internet traffic."
  };
