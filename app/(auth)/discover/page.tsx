...
<div className='bg-[#f2f3f5] md:px-28 px-5 py-20 text-2xl text-gray-900'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 py-20">
            <div className="max-w-xl p-3 flex flex-col text-center">
                <img src="/icons/interaction.png" className='h-10 mx-auto' alt="icon"/>
                <div className='py-5'>
              <Link href="/discover/user-behaviour-discovery" ><span className='underline text-violet-950'>User Behaviour Discovery</span></Link>
                </div>
            ...
            <div className="max-w-xl p-3 md:border-l md:border-r border-gray-300 flex flex-col text-center">
                <img src="/icons/defense.png" className='h-10 mx-auto' alt="icon"/>
                <div className='py-5'>
            ...
            <div className="max-w-xl p-3  flex flex-col text-center">
                <img src="/icons/dynamic.png" className='h-10 mx-auto' alt="icon"/>
                <div className='py-5'>
              <Link href="/discover/sensitive-data-discovery" ><span className='underline text-violet-950'>Sensitive Data Discovery</span></Link>
                </div>
