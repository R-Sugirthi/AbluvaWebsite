...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Least Privilege | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Least Privilege."
  };
  
  const mainTerm = {
    "title": "Least Privilege",
    "description": "A security principle granting users only the minimum access permissions necessary to fulfill their job duties, minimizing potential damage from unauthorized access."
  };
  
  const relatedTerms = [
    {
      "title": "Legal Basis For Processing",
      "description": "As per GDPR, data controllers must demonstrate a lawful justification for processing personal data. The six legal bases include consent, necessity, contract requirements, legal obligations, protection of data subjects, public interest, or legitimate controller interests."
    },
    {
      "title": "LLM",
      "description": "Large Language Models (LLMs) represent a forefront advancement in Natural Language Processing (NLP), engineered to comprehend and generate human language. These sophisticated AI models undergo extensive training on massive datasets of textual information, empowering them to discern linguistic nuances, grasp context, and generate responses that are both coherent and contextually appropriate. While NLP lays the groundwork for machines to engage with language, LLMs epitomize a specialized methodology that fontedly elevates machines' capacity to emulate human-like language comprehension and generation."
    }
  ];
