...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Loss Prevention (DLP) | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data loss prevention."
  };
  
  const mainTerm = {
    "title": "Data Loss Prevention (DLP)",
    "description": "Data loss prevention (DLP) refers to the strategies and technologies used to prevent the unauthorized loss or exposure of sensitive data."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "Data Leakage",
      "description": "Data leakage, also known as data loss, refers to the unauthorized transmission of data from within an organization to an external destination or recipient."
    }
  ];
