...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Insider Threat | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for Insider Threat."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "IRM",
      "description": "A subset of Digital Rights Management, IRM utilizes encryption and permission management to protect corporate information from unauthorized access or editing."
    }
  ];
