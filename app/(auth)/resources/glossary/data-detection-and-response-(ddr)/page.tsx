...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Detection and Response (DDR) | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data detection and response (DDR)."
  };
  
  const mainTerm = {
    "title": "Data Detection and Response (DDR)",
    "description": "DDR acts as a critical line of defense, enabling real-time detection and remediation of data security threats across various cloud platforms."
  };
