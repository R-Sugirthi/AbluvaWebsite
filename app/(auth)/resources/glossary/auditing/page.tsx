...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Auditing | Abluva Glossary",
  ...
  const relatedTerms = [
    ...
    {
      "title": "Authorization",
      "description": "Authorization refers to the security mechanism responsible for determining and enforcing the actions authenticated users are permitted to perform within a computer system. The primary forms of authorization include DAC, MAC, and RBAC."
    }
  ];
