...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Defense Industrial Base | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for the Defense Industrial Base."
  };
  
  const mainTerm = {
    "title": "Defense Industrial Base",
    "description": "The Defense Industrial Base (DIB) encompasses companies crucial to the U.S. military's operations, providing research, production, delivery, and maintenance of essential equipment and services."
  };
  
  const relatedTerms = [
    {
      "title": "Data Loss",
      "description": "The unintentional or malicious disappearance of data (deletion, corruption, theft). Robust backup strategies, security measures, and data recovery plans are crucial for mitigating data loss risks and ensuring information availability."
    },
    {
      "title": "Data Theft",
      "description": "The unauthorized and unlawful acquisition of sensitive information through various methods (hacking, insider threats, physical theft). Robust security measures, access controls, and employee awareness training are crucial for mitigating data theft risks."
    }
  ];
