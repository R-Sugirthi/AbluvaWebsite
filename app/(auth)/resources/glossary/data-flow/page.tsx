...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Flow | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data flow."
  };
  
  const mainTerm = {
    "title": "Data Flow",
    "description": "Data flow refers to the designated path information travels from its origin to its final destination, traversing various intermediary points within a system or network."
  };
  ...
  const relatedTerms = [
    ...
    },
    {
      ...
      "description": "A visual representation depicting the movement of information within a process or system."
    }
  ];
