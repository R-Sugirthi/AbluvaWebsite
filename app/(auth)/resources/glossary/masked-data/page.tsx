...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Masked Data | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for masked data."
  };
  
  const mainTerm = {
    "title": "Masked Data",
    "description": "Masked data refers to sensitive information that has been replaced with lookalike arbitrary data, rendering it useless for malicious actors. This approach is often used in test or development environments, enabling software development with realistic data without exposing actual information."
  };
  ...
  const relatedTerms = [
    ...
    },
    {
      ...
      "description": "A managed database is a database where storage, data, and computing services are outsourced to a third-party provider, relieving internal IT staff from management and maintenance tasks."
    }
  ];
