...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Passive Data Collection | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for passive data collection."
  };
  
  const mainTerm = {
    "title": "Passive Data Collection",
    "description": "Passive data collection refers to the automatic gathering of information, with or without the user's awareness. Examples include website visit logs, social media activity tracking, and location data collected through mobile devices. Balancing convenience with potential privacy concerns is crucial in responsible data collection practices."
  };
  
  const relatedTerms = [
    {
      "title": "PCI DSS",
      "description": "The Payment Card Industry Data Security Standard (PCI DSS) defines security protocols for credit card transactions, safeguarding cardholder information against misuse."
    },
    {
      "title": "Pen Testing",
