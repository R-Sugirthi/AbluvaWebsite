...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Certification | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "Certification",
    "description": "In the world of security and compliance, a certification acts as an official recognition by a trusted authority. It signifies that an organization or product demonstrably meets established security or compliance standards, providing assurance to stakeholders and customers."
  };
  
  const relatedTerms = [
    {
      "title": "CMMC",
      "description": "The Cybersecurity Maturity Model Certification (CMMC) establishes a standardized framework for assessing cybersecurity maturity in organizations working with the U.S. Department of Defense (DoD)."
    },
    {
      "title": "CSP",
      "description": "Cloud Service Provider (CSP) offers various service models (IaaS, PaaS, SaaS), delivering on-demand access to computing resources and capabilities over the internet."
    }
  ];
