...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Managed Database | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for managed database."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "Masked Data",
      "description": "Sensitive information replaced with lookalike arbitrary data, rendering it useless for malicious actors. This approach is often used in test or development environments, enabling software development with realistic data without exposing actual information."
    }
  ];
