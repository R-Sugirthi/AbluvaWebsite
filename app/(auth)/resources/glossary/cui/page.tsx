...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "CUI | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "CUI",
    "description": "Controlled Unclassified Information (CUI) falls into a distinct category within the U.S. government's information classification system."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "Consent",
      "description": "Consent empowers individuals to make informed choices about the collection and processing of their personal information."
    }
  ];
