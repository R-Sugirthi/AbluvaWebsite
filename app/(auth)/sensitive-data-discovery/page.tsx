        ...
        <div className='bg-[#f2f3f5] md:px-28 pt-20 text-2xl text-gray-900'>
          ...
          <div className='py-20'>
            ...
            <div className="link-wrapper">
              <Link className="hover-2 text-gradient-light text-3xl font-semibold" href="/contact">Get in touch with our team to schedule a personalized demo or start your free trial today &#x2192;</Link>
            </div>
          </div>
        </div>
