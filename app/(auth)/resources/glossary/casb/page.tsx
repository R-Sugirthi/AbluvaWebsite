...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "CASB - Cloud Access Security Broker | Abluva Glossary",
  ...
  const mainTerm = {
    ...
    "description": "Operating as a security checkpoint for cloud applications, CASBs monitor and control employee access to cloud services. Often deployed through proxy servers, CASBs manage Shadow IT risks, enforce acceptable use policies for sanctioned SaaS applications, and monitor activities within those applications. However, they do not extend to monitoring third-party activities like shared documents or email within the cloud environment."
  };
  
  const relatedTerms = [
    {
      "title": "CDO",
      "description": "Chief Data Officer (CDO) is an executive responsible for managing an organization's data assets and data governance strategy. The CDO oversees data quality, data security, data privacy, and compliance with data regulations."
    },
    {
      "title": "Certification",
      "description": "Certification is an official recognition by a trusted authority that an organization or product meets specific security or compliance standards. Certifications provide assurance to stakeholders and customers."
    }
  ];
