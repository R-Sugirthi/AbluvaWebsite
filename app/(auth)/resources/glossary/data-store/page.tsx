...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Store | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data storage."
  };
  
  const mainTerm = {
    "title": "Data Store",
    "description": "A data store is a centralized repository for managing and distributing large datasets within an enterprise. It provides secure, organized storage and facilitates efficient access and retrieval of data for various applications and analytics needs."
  };
  ...
  const relatedTerms = [
    ...
    {
      "title": "Data Flow",
      "description": "Data flow is the designated path information travels from its origin (source) to its final destination, traversing various intermediary points (nodes) within a system or network."
    }
  ];
