...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Confidentiality | Abluva Glossary",
    "description": "Expand your knowledge with our glossary of cybersecurity and data protection terms."
  };
  
  const mainTerm = {
    "title": "Confidentiality",
    "description": "Confidentiality is a cornerstone of information security, guaranteeing that sensitive data is only accessible to authorized individuals or entities."
  };
