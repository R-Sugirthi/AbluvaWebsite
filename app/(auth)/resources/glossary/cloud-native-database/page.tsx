...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Cloud Native Database | Abluva Glossary",
  ...
  const mainTerm = {
    ...
    "description": "Cloud native databases are database services hosted and delivered by cloud service providers (CSPs) using cloud-based technologies and architectures."
  };
  
  const relatedTerms = [
    {
      "title": "CSP",
      "description": "Cloud Service Provider (CSP) delivers on-demand access to computing resources and capabilities over the internet."
    },
    {
      "title": "CMMC",
      "description": "Cybersecurity Maturity Model Certification (CMMC) establishes a standardized framework for assessing cybersecurity maturity."
    }
  ];
