...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Exact Matching | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for exact matching."
  };
  
  const mainTerm = {
    "title": "Exact Matching",
    "description": "In queries, algorithms, or searches, an exact match signifies a 100% concordance between the search terms and retrieved results."
  };
