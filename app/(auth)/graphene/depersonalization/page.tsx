...
export const metadata = {
  ...
  description: 'Safely share data with Graphene\'s advanced masking and fine-grain controls for enhanced security and compliance.',
};
      ...
      <section className='founder'>
        <div className="bg-black text-black text-center py-20">
          <div className="px-4 sm:px-8 lg:px-16 xl:px-20">
            ...
            <div className='pb-28'>
              <Link href="/company/contact" className="btn-md  font-semibold text-xl text-white bg-violet-950 py-4 p-3 rounded-md">
                Request to Demo
              </Link>
            </div>
        ...
        <div className='bg-[#f2f3f5] px-4 lg:px-28 md:pb-10'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
            <div className="max-w-xl p-10 md:border-b border-gray-300 flex flex-col justify-center items-center">
              <ul>
                <li className='py-3'><img src="/icons/dynamic.png" className='h-8 mx-auto' alt="icon"/></li>
            ...
            <div className="max-w-xl p-10 md:border-l md:border-r md:border-b border-gray-300 flex flex-col justify-center items-center">
              <ul>
                <li className='py-3'><img src="/icons/encryption.png" className='h-8 mx-auto' alt="icon"/></li>
            ...
            <div className="max-w-xl p-10 md:border-b border-gray-300 flex flex-col justify-center items-center">
              <ul>
                <li className='py-3'><img src="/icons/skills.png" className='h-8 mx-auto' alt="icon"/></li>
            ...
            <div className="max-w-xl p-10 flex flex-col justify-center items-center">
              <ul>
                <li className='py-3'><img src="/icons/solution.png" className='h-8 mx-auto' alt="icon"/></li>
            ...
            <div className="max-w-xl p-10 flex flex-col justify-center items-center">
              <ul>
                <li className='py-3'><img src="/icons/securedData.png" className='h-8 mx-auto' alt="icon"/></li>
        ...
        <div className='bg-[#f2f3f5] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:px-28 px-5 md:py-20 py-5'>
          ...
          <div className='image-container flex items-center'>tion
            <img src="https://img.freepik.com/premium-photo/computer-security-vulnerability-concept-open-padlock-laptop-with-colorful-lights_136875-3399.jpg?w=740" className='rounded-lg' alt="data-depersonalization" />
        ...
        <div className=' flex items-center order-2 md:order-1'>
          <div className='image-container'>
            <img src="https://img.freepik.com/free-vector/computer-with-big-data-stream-isometric-banner_107791-248.jpg?w=826&t=st=1702400205~exp=1702400805~hmac=04b7685f08c018184e42ea3604d13b3aa8bb567bf1bd98630528bb5b86923bb2" className='rounded-lg' alt="data-depersonalization"/>
            <div className='image-overlay rounded-lg'></div>
          </div>
          </div>
        ...
        <div className='bg-[#f2f3f5] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:px-28 px-5 md:py-20 py-5'>
          ...
          <div className='image-container flex items-center'>
            <img src="https://img.freepik.com/premium-photo/futuristic-industry-40-engineering-conceptual_31965-32018.jpg?w=900" className='rounded-lg' alt="data-depersonalization"/>
            <div className='image-overlay rounded-lg'></div>
          </div>
        </div>
