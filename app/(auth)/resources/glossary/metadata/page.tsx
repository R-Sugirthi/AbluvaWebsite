...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Metadata | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for metadata."
  };
  
  const mainTerm = {
    "title": "Metadata",
    "description": "Metadata refers to data that describes other data. In database contexts, it encompasses information about the data store itself and the schema definition."
  };
