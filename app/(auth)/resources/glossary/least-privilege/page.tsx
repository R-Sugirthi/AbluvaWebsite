...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    ...
    "description": "Learn about the principle of least privilege in our glossary."
  };

  const mainTerm = {
    "title": "Least Privilege",
    "description": "Least Privilege is a security principle granting users only the minimum access permissions necessary to fulfill their job duties, minimizing potential damage from unauthorized access."
  };
  const relatedTerms = [
    {
