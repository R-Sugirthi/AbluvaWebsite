    ...
    <>
      ...
      <section className='founder'>
        ...
        <div className='bg-black px-4 md:px-28 pb-20 text-2xl darkText text-gray-300'>
          <h1 className="md:text-5xl text:3xl text-gradient lineht text-center pt-5">GNN based anomaly detection and analysis</h1>
          <h1 className="md:text-3xl text:2xl text-center pb-10">Unmatched transparency with advanced graph neural network (GNN)</h1>
          <p className='py-3'>
          Graphene harnesses the power of advanced Graph Neural Networks (GNNs) to fortify the  security posture. Witness unparalleled transparency in threat identification without compromising complexity.
           ...
           <h1 className="md:text-2xl text:2xl text-gray-300 font-semibold">Benefits of Graphene's GNN Explainer Capability</h1>
          <div className='py-5'>
...
<div className="link-wrapper  text-center">
        ...
        <div className='bg-[#f2f3f5] md:px-28 pt-20 pb-20 text-2xl text-gray-900 ' id="AttackPath">
        ...
        <div className='bg-black md:px-28 py-28 text-2xl text-gray-300 darkText ' id="DataGovernance">
        ...
        <div className='bg-[#f2f3f5] md:px-28 pt-28 pb-20 text-2xl text-gray-900' id="SecureKnowledgeGraph">
        <h1 className="md:text-5xl text:3xl text-gradient-light lineht text-center">Graphene Secure Knowledge Graphs</h1>
        <h1 className="md:text-3xl text:2xl text-gray-900 text-center">Empowering intelligence, ensuring security</h1>
        <p className='pt-20'>
        ...
        <div className='pt-10'>
        <div className='border border-gray-500 rounded-lg p-10'>
        <h1 className="md:text-3xl text:2xl text-gray-900 font-semibold">Graphene's Knowledge Graph key features: </h1>
          <ul className='list-disc ml-10'>
