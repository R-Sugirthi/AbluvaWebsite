...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Breach Notification | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data breach notification."
  };
  
  const mainTerm = {
    "title": "Data Breach Notification",
    "description": "Following a data breach where unauthorized access or exposure of sensitive data occurs, organizations are obligated to inform both regulatory authorities and affected individuals."
  };
  
  const relatedTerms = [
    {
      "title": "Data Breach",
      "description": "A data breach refers to a security incident where sensitive, protected, or confidential data is compromised due to unauthorized access or exposure."
    },
    {
      "title": "Data Leak Prevention (DLP)",
      "description": "DLP serves as a security filter, specifically designed to prevent the unauthorized sharing or transfer of sensitive data outside an organization."
    }
  ];
