...
const GlossaryPage: React.FC = () => {
  ...
  const glossaryMeta = {
    "title": "Data Centric Security | Abluva Glossary",
    "description": "Expand your knowledge with our glossary term for data centric security."
  };
  
  const mainTerm = {
    "title": "Data Centric Security",
    "description": "Data centric security focuses on protecting the data itself rather than the systems or networks surrounding it."
  };
